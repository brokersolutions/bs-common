...
import bs.common.payment.openpay.OpenPayCard.OpenPayCardPoints;
import bs.common.payment.openpay.OpenPayCard.OpenPayCardPoints.OpenPayCardPointsResponse;
...
public abstract class OpenPayPayment {
	...
	protected OpenPayCustomerResponse createCustomer(final OpenPayCustomer bean) throws Exception {
		try {
			...
			if(ValidatorUtil.isNotEmpty(bean)) {
	...
	protected OpenPayChargeResponse charge(final OpenPayCharge bean) throws Exception {
		try {
			...
			if(bean != null) {
				...
				if(ValidatorUtil.isNotEmpty(orderId)) {
