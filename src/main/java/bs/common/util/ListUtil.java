...
public class ListUtil implements Serializable {
	...
	public static String toString(List<String> list, String delimiter) {
		if (ValidatorUtil.isNotEmpty(list) && ValidatorUtil.isNotEmpty(delimiter)) {
	...
	public static List<String> toList(String source, String delimiter) {
		if (ValidatorUtil.isNotEmpty(source) && ValidatorUtil.isNotEmpty(delimiter)) {
	...
	public static <T> List<T> concat(List<T> list1, List<T> list2) {
		if (ValidatorUtil.isEmpty(list1) && ValidatorUtil.isEmpty(list2)) {
			return Collections.emptyList();
		}

		if (ValidatorUtil.isEmpty(list2)) {
			return list1;
		}

		if (ValidatorUtil.isEmpty(list1)) {
			return list2;
		}
	...
	public static <T> List<T> merge(List<T> list1, List<T> list2) {
		if (ValidatorUtil.isNotEmpty(list1) && ValidatorUtil.isNotEmpty(list2)) {
			val set = new HashSet<T>();
			set.addAll(list1);
			set.addAll(list2);
