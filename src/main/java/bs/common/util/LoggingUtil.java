...
public class LoggingUtil implements Serializable {
	private static final long serialVersionUID = -8734912425558869305L;
	...
	public static void intervalTime(String resource) {
		if (inWatch.isStarted()) {
			if (ObjectUtils.isEmpty(resource)) {
				resource = "LoggingUtils#intervalTime";
			}
	...
	public static void intervalSummary(String resource) {
		if (inWatch.isStarted()) {
			if (ObjectUtils.isEmpty(resource)) {
				resource = "LoggingUtils#intervalSummary";
			}
